...
public class ItemDetailAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDriverBreaking.setText("Driver Breaking: " + objCarData.getDriverBreaking());
        ...
        txtPassengerDoorAjar.setText("Passenger Door: " + objCarData.getPassengreDoorAjar());
        ...
        txtParkBreakeActive.setText("Park Breake Active: " + objCarData.getParkBreakeActive());
